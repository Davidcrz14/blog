...
const StoryCard = ({ title, excerpt, category, readTime, slug }) => (
    <Link to={`/historias/${slug}`} className="block">
        <article className="retro-card hover:cursor-pointer transform transition-all hover:-translate-y-1">
            <div className="p-6">
...
const QuoteCard = ({ quote, author }) => (
    <div className="retro-card p-6 transform transition-all hover:scale-105">
    ...
    return (
        <div className="space-y-12">
            <section className="text-center animate-slide-in">
                <h1 className="text-6xl font-bold mb-4">Historias & Reflexiones</h1>
