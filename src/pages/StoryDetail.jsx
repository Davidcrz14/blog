        ...
        <div className="fixed bottom-4 right-4 z-50">
            <div className="retro-card p-4 bg-[#f5e6d3] shadow-xl flex flex-col items-center space-y-2">
                ...
                <div className="flex space-x-2">
                    <button
                        onClick={togglePlay}
                        className="retro-button w-12 h-12 flex items-center justify-center text-xl"
                    ...
                    <button
                        onClick={toggleLoop}
                        className={`retro-button w-12 h-12 flex items-center justify-center ${isLoop ? 'bg-[#2c1810] text-[#f5e6d3]' : ''}`}
                        title={isLoop ? 'Modo Loop: Activado' : 'Modo Loop: Apagado'}
                    >
                        {isLoop ? 'ON' : 'OFF'}
                    </button>
                </div>
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className="retro-button w-8 h-8 flex items-center justify-center text-sm"
                        title="Bajar volumen"
                    >
                        -
                    </button>
                    <div className="w-16 h-2 bg-[#2c1810] rounded-full overflow-hidden">
                        <div
